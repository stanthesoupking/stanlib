...
SL_Atlas_Packer* sl_atlas_packer_new(Allocator* allocator);
...
bool sl_atlas_packer_finalise(SL_Atlas_Packer* packer, u32 max_width, u32 gutter, vec2_u32* out_required_size);
